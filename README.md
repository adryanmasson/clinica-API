# 🏥 Clínica do Campus - Sistema de Gestão Médica
...
**Sistema completo de gestão de clínica médica com API RESTful, gestão de consultas, prontuários eletrônicos e auditoria automática.**

[🌐 Demo ao Vivo](https://clinica-api-adryan.azurewebsites.net/api/especialidades) | [📖 Documentação](#-endpoints-da-api) | [🚀 Deploy](#-deploy-no-azure)
...
Sistema de gestão completo para clínicas médicas, desenvolvido com **Spring Boot** e **SQL Server**, oferecendo controle total sobre:

- 👨‍⚕️ **Gestão de Médicos e Especialidades**
- 👤 **Cadastro e Histórico de Pacientes**
- 📅 **Agendamento e Controle de Consultas**
- 📝 **Prontuários Eletrônicos com Auditoria Automática**
- 🔍 **Consultas Avançadas e Relatórios**

### 🎯 Destaques Técnicos

- ✅ **Arquitetura RESTful** com padrão de resposta padronizado
- ✅ **Migração completa** de MySQL para SQL Server com otimizações
- ✅ **Stored Procedures e Functions** nativos do SQL Server
...
- ✅ **Validações de Negócio** em múltiplas camadas (DB + Application)
- ✅ **Spring Security** configurado com CORS para integração frontend
...
- **T-SQL** - Procedures, functions e triggers customizadas
- **Azure SQL Database** - Hospedagem em cloud
